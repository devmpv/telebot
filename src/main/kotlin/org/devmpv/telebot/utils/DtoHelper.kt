...
fun Double.roundToScale1() = this.toBigDecimal().setScale(1, RoundingMode.UP).toDouble()
...
fun Hourly.toWeatherData(zoneId: ZoneId) = WeatherData(
    ...
    sunrise = null,
    sunset = null,
    temp = this.temp.roundToScale1(),
    feelsLike = this.feels_like.roundToScale1(),
...
fun Daily.toWeatherData(zoneId: ZoneId) = WeatherData(
    ...
    sunrise = null,
    sunset = null,
    temp = this.temp.day.roundToScale1(),
    feelsLike = this.feels_like.day.roundToScale1(),
    pressure = this.pressure.toMhg(),
    humidity = this.humidity,
    clouds = this.clouds,
    wind_speed = this.wind_speed,
